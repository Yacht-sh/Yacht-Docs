...
Welcome to Yacht's new documentation. It's built with [**Docusaurus v2**](https://v2.docusaurus.io/) which uses react to build out the documentation, blog, and main website. I'll be posting updated about new features, releases, and tutorials as I'm able to.
<!--truncate-->
